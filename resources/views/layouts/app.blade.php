    ...
    <div class="flex flex-col w-full dark:bg-gray-800">
        <div
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <li class="relative">
                    <button
                        class="align-middle rounded-full text-paleta_tesis_blanco bg-paleta_tesis_celeste h-10 w-10 focus:shadow-outline-purple focus:outline-none"
                    ...
                    <template  x-if="isProfileMenuOpen">
                        <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                            ...
                            class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-paleta_tesis_celeste border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700"
                            aria-label="submenu">
                            <li class="flex text-paleta_tesis_blanco ">
                                <span>{{ Auth::user()->name.' '.Auth::user()->surname }}</span>
                            </li>
                            <li class="flex">
                                <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                    href="{{ route('hosts.profile') }}">
                                    <svg class="w-4 h-4 mr-3 text-paleta_tesis_blanco" aria-hidden="true" fill="none" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z">
                                        </path>
                                    </svg>
                                    <span class="text-paleta_tesis_blanco">Perfil</span>
                                </a>
                            </li>
                            <li class="flex  hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200 transition-colors duration-150 rounded-md">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button
                                        class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold "
                                        href="#">
                                        <svg class="w-4 h-4 mr-3 text-paleta_tesis_blanco" aria-hidden="true" fill="none"
                                        ...
                                        <span class="text-paleta_tesis_blanco">Cerrar sesion</span>
                                    </button>
                                </form>
                            </li>
                        </ul>

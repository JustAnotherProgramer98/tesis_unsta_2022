<div id="create" class="tabcontent hidden container items-center px-5 py-12 lg:px-20 ">
    ...
    class="mb-4 bg-transparent hover:bg-paleta_tesis_azul text-paleta_tesis_azul font-semibold hover:text-white py-2 px-4 border-2 border-paleta_tesis_azul hover:border-transparent rounded"><i class="fas fa-arrow-left"></i>
    Volver </button>
    @if ($errors->any())

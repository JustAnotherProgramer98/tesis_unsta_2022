<div id="create" class="tabcontent container items-center hidden">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('places.store.admin') }}" class="flex flex-col p-10 px-8 pt-6 mx-auto my-6 mb-4 transition duration-500 ease-in-out transform w-11/12">
        @csrf

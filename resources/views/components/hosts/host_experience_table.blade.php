        ...
        <table class="w-full bg-black">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                @forelse (Auth::user()->experiences as $experience)
                    ...
                    <tr onclick="showExperience(event, 'show_experience_detail',{{ $experience }},'{{ $experience->images->first()? asset($experience->images->first()->url): addslashes('Sin imagenes') }}','{{ $experience->place->city->province->name }}','{{ $experience->place->city->name }}','{{ addslashes(Str::limit($experience->place->adress, 10)) }}')"

        ...
        <thead>
          <tr class="h-12 uppercase">
            ...
            <th class="lg:text-right text-left pl-5 lg:pl-0">
              ...
              <span class="hidden lg:inline">Participantes</span>
            </th>
            <th class="hidden text-right md:table-cell">Precio Unico</th>
            <th class="text-right">Precio Total</th>
          </tr>
        </thead>
        <tbody>
       
            @foreach ($experiences->take(2) as $experiencie)
          <tr>
            ...
            <td>
              <a href="#">
                <p class="mb-2 md:ml-4">{{ $experiencie->title }}</p>

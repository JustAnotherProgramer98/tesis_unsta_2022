        ...
        <div class="h-full overflow-hidden">
            ...
            <div id="index" class="tabcontent mt-4 mx-4 block">
                ...
                <div class="flex gap-4 mb-4">
                    ...
                    class="mb-4 bg-transparent hover:bg-paleta_tesis_celeste text-paleta_tesis_celeste font-semibold hover:text-white py-2 px-4 border border-paleta_tesis_celeste hover:border-transparent rounded">Crear experiencia </button>

...
<div id="index" class="tabcontent block py-8 pb-20 px-4 ">
  ...
  <div class="flex gap-4 my-4 ">
    ...
    class="mb-4 bg-transparent hover:bg-paleta_tesis_celeste text-paleta_tesis_celeste font-semibold hover:text-white py-2 px-4 border border-paleta_tesis_celeste hover:border-transparent rounded">Crear una experiencia </button>
